...
def reg_test(name, asm_str, reg_num, exptected_val, timeout_cycles, reg_init=[], verbose=False):
    from io import StringIO
    source_file = StringIO(asm_str)
    from asm_dump import dump_asm
    cpu = MtkCpu(reg_init=reg_init, mem_init=dump_asm(source_file, verbose=verbose))
